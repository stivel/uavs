webpackJsonp([5], {
    ...
    "+YOn": function(e, t, n) {
        ...
        function o(e, t, n, r, o) {
            window.gaevent(e, t, n, r, o),
            window.baevent(e, t, n, r, o)
        }
        function i() {
            window.resendGA(),
            window.resendBA()
        ...
        default)(t, [{
            ...
            },
            {
                ...
                value: function() {
                    ...
                    return window.maevent(e.ga.category, "show"),
                    1 === e.pics.length ? this.singleImage(e) : this.smallImage(e)
                }
            }]),
            t
        } (h.Component);
    ...
    "1P2o": function(e, t, n) {
        ...
        t.
    default = !("undefined" == typeof window || !window.document || !window.document.createElement),
        e.exports = t.
    default
    },
    "1uVg": function(e, t, n) {
        ...
        var x = function(e) {
            ...
            default)(this, (t.__proto__ || (0, i.
            default)(t)).call(this));
                return e.createMarkup = e.createMarkup.bind(e),
                e
            }
            return (0, p.
        default)(t, e),
    ...
    "2SGS": function(e, t, n) {
        ...
        default)(t, [{
            ...
            },
            {
                ...
                value: function() {
                    var e = this,
                    t = this.props.GTMValue.hideTopBar || this.props.hideTopBar,
                ...
                default, null)), this.props.showAuditBtn ? m.
                default.createElement("span", {
                        className: "abs_r",
                        onClick: function() {
                            return e.props.onClickShowAuditInfo()
                ...
                default.createElement("a", {
                        href: w.
                    default.appendQuery("//m.toutiao.com/search/", "need_open_window=1"),
        ...
        "use strict"; (function(t) {
            ...
            a = function(e, t) {
                ...
                function o(e, t) {
                    ...
                    s.push("L" + o.join(",")),
                    s.push("L" + n.join(",")),
                    a.find("path").attr("d", s.join(" ")),
                    a[0].setAttribute("refX", i[0]),
                    a[0].setAttribute("refY", i[1])
                }
                function i(t) {
                    t = e.extend({
                        x: 0,
                    ...
                    var i = t.radius,
                    a = t.margin,
                    s = i + a + i * Math.sin(n(t.endDegree)),
                    u = i + a - i * Math.cos(n(t.endDegree)),
                    l = i + a + i * Math.sin(n(t.startDegree)),
                    ...
                    u = r.px2px(u);
                    var d = [["M" + l, c].join(",")];
                    d.push([["A" + i, i].join(","), "0", [t.endDegree - t.startDegree > 180 ? "1": "0", "1"].join(","), [s, u].join(",")].join(" "));
                    var f = d.join(" ");
                    e(t.pathObj).attr("d", f).css("stroke", t.color),
                    e(t.arrowObj).find("path").css("fill", t.color),
                    o(t.arrowSize, e(t.arrowObj))
                }
                return {
                    drawArc: i
                }
            ...
            s = function(e, t) {
                ...
                m = function() {
                    ...
                    o = (n.match(/firefox\/([\d.]+)/), n.match(/mx[\d.]+/)),
                    i = !1;
                    return o && r && (i = !0),
                    !t && i
                } (),
                ...
                return v.prototype = {
                    ...
                    _needRefresh: function(e) {
                        return e = h(e),
                        !this.shouldRefresh && e >= this.minRefreshDistance && (this.shouldRefresh = !0),
                        this.shouldRefresh
                    },
                    ...
                    canvasObj: function() {
                        ...
                        function u() {
                            if (!m) {
                                ...
                                if (!E && (o({
                                    ...
                                    co: l,
                                    clearRect: d
                                }), I >= W)) if (T.closePath(), U = "erase" !== V ? F: P, "draw" === (V = "erase" !== V ? "erase": "draw")) {
                                    D = U.color;
                                    var f = t(D);
                                    U.color = N[f],
                                    U.startAngle = (U.startAngle - q) % 360,
                                    I = U.startAngle,
                                    W = n(I)
                        ...
                        function f() {
                            ...
                            return s(function e() {
                                if (o >= 0) {
                                    ...
                                    o -= n * (t - i),
                                    i = t;
                                    var u = o / (x.minRefreshDistance - c),
                                    l = (W - p) * u - P.startAngle,
                                    d = B - l;
                                    d = Math.min(d, B),
                                    h({
                                        start: d,
                        ...
                        function h(t) {
                            ...
                            E ? a.drawArc({
                                ...
                                color: t.color
                            }) : (T.strokeStyle = t.color, T.fillStyle = t.color, i.drawArcedArrow(T, O, C, A, _(t.start), _(t.end), !1, 1, 2, _(45), o, L, s))
                        }
                        function v(e) {
                            var t = 0;
                            if (e) {
                        ...
                        function w(e, t) {
                            var n = e;
                            t || (n = Math.max(0, (e - c) / x.minRefreshDistance * 360)),
                        ...
                        return {
                            init: function(e, t) {
                                ...
                                K = 0,
                                S = !1,
                                k = e.find("#load-tip-svg")[0] || e.find("#load-tip-canvas")[0],
                                T = k.getContext ? k.getContext("2d") : k,
                                E = !k.getContext,
                                B = I = 0,
                                P.startAngle = F.startAngle = 0,
                                W = n(I),
                                R = 1,
                                P.color = N[R],
                                V = "draw",
                                U = P,
                                x = t,
                                E ? (M = 9, O = C = A = (40 - 2 * M) / 2) : (O = C = 100, M = 0, A = 50)
                            },
                            reset: function() {
                                k = null,
                                T = null
                    ...
                    addPullTip: function(t) {
                        ...
                        if (!n) {
                            var r = [];
                            r.push("<div class='list_top'>"),
                            r.push("<div class='list_top_con v2'>");
                            r.push("<canvas                             id='load-tip-canvas'                             width='200'                             height='200'                             class='" + (m ? "not-support": "") + "'></canvas>"),
                            r.push("</div></div>"),
                            this.$pullTip = e(r.join("")).insertAfter("body"),
                            n = this.$pullTip,
                            this.minRefreshDistance = n.outerHeight();
                            var o = n[0];
                            o.style.webkitTransition = "none",
                            o.style.webkitTransform = "translate3d(0,10px,0)",
                            o.style.top = t.getBoundingClientRect().top - this.minRefreshDistance + "px",
                            this.initCanvas()
                        }
                    },
                    movePullTip: function(e, t, n) {
                        if (this.pullTipExist()) {
                            var r = Math.min(f(), e);
                            this.$pullTip[0].style.webkitTransition = t || "none",
                            this.$pullTip[0].style.webkitTransform = "translate3d(0," + r + "px,0)",
                            0 === e ? this.canvasObj.clearCurrent() : e > c && (this.shouldRefresh ? this.isRefreshing || !0 === n || this.canvasObj.rotate(e) : (e <= f() - 5 && this.canvasObj.rotate(e), this.canvasObj.drawArrowedArcByDis(e - c), this.canvasObj.changeOpacity(e - c)))
                        }
                    },
                    ...
                    removePullTip: function(t) {
                        if (this.pullTipExist()) if (t) {
                            ...
                            n.$pullTip[0].style.webkitTransition = "all 100ms linear",
                            n.$pullTip.css("opacity", .1),
                            n.$pullTip[0].style.webkitTransform += " scale(0.1)"
                        } else this.$pullTip[0].removeEventListener("webkitTransitionEnd", this.onTransitionEnd, !1),
                        this.$pullTip.remove(),
                        this.$pullTip = null,
                        e(window).trigger("pullrefresh_pulltip_removed")
                    }
                },
                {
                    init: function(e) {
    ...
    "3Cyt": function(e, t, n) { (function(t, n) {
            ...
            function() {
                return function(e) {
                    ...
                    e.exports.compiler = n(3),
                    e.exports.parser = n(3),
                    e.exports.lexer = n(3),
                    e.exports.runtime = n(8),
                    e.exports.lib = r,
                    e.exports.nodes = n(3),
                    e.exports.installJinjaCompat = n(16);
                    var u;
                    e.exports.configure = function(e, t) {
                        ...
                        u = new o.Environment(n, t),
                        t && t.express && u.express(t.express),
                        u
                    },
                    e.exports.compile = function(t, n, r, o) {
                        return u || e.exports.configure(),
                        new e.exports.Template(t, n, r, o)
                    },
                ...
                function(e, t) {
                    ...
                    t.TemplateError = function(e, t, n) {
                        ...
                        return r.name = "Template render error",
                        r.message = e,
                        r.lineno = t,
                        r.colno = n,
                        r.firstUpdate = !0,
                    ...
                    t.groupBy = function(e, n) {
                        for (var r = {},
                        o = t.isFunction(n) ? n: function(e) {
                            return e[n]
                        },
                        i = 0; i < e.length; i++) {
                            var a = e[i],
                            s = o(a, i); (r[s] || (r[s] = [])).push(a)
                        }
                        return r
                    },
                    ...
                    t.without = function(e) {
                        ...
                        for (var r = -1,
                        o = e.length,
                        i = t.toArray(arguments).slice(1); ++r < o;) - 1 === t.indexOf(i, e[r]) && n.push(e[r]);
                        return n
                    },
                    ...
                    t.each = function(e, t, r) {
                        if (null != e) if (n.each && e.each === n.each) e.forEach(t, r);
                        else if (e.length === +e.length) for (var o = 0,
                        i = e.length; o < i; o++) t.call(r, e[o], o, e)
                    },
                    t.map = function(e, t) {
                        var r = [];
                        if (null == e) return r;
                    ...
                    function(e, t, n) {
                        ...
                        var r = this.length >>> 0;
                        for (n = +n || 0, Math.abs(n) === 1 / 0 && (n = 0), n < 0 && (n += r) < 0 && (n = 0); n < r; n++) if (e[n] === t) return n;
                        return - 1
                    },
                ...
                function(e, t, n) {
                    ...
                    var v = u.extend({
                        init: function(e, t) {
                            ...
                            this.loaders = [],
                            e ? this.loaders = s.isArray(e) ? e: [e] : d.FileSystemLoader ? this.loaders = [new d.FileSystemLoader("views")] : d.WebLoader && (this.loaders = [new d.WebLoader("/views")]),
                            window.nunjucksPrecompiled && this.loaders.unshift(new d.PrecompiledLoader(window.nunjucksPrecompiled)),
                            this.initCache(),
                            this.globals = p(),
                            this.filters = {},
                            this.asyncFilters = [],
                        ...
                        initCache: function() {
                            ...
                            function(e) {
                                e.cache = {},
                                "function" == typeof e.on && e.on("update",
                                function(t) {
                                    e.cache[t] = null
                                })
                            })
                        ...
                        getTemplate: function(e, t, n, r, i) {
                            var a = this,
                            u = null;
                            if (e && e.raw && (e = e.raw), s.isFunction(n) && (i = n, n = null, t = t || !1), s.isFunction(t) && (i = t, t = !1), e instanceof o) u = e;
                            else {
                            ...
                            if (!u) {
                                ...
                                p = function(n, a) {
                                    if (a || n || r || (n = new Error("template not found: " + e)), n) {
                                        ...
                                        var s;
                                        a ? (s = new o(a.src, f, a.path, t), a.noCache || (a.loader.cache[e] = s)) : s = new o("", f, "", t),
                                        i ? i(null, s) : d = s
                                    }
                                };
                                return s.asyncIter(this.loaders,
                                function(t, r, o, i) {
                                    function s(e, n) {
                                        e ? i(e) : n ? (n.loader = t, i(null, n)) : o()
                                    }
                                    e = a.resolveTemplate(t, n, e),
                        ...
                        renderString: function(e, t, n, r) {
                            return s.isFunction(n) && (r = n, n = {}),
                            n = n || {},
                            new o(e, this, n.path).render(t, r)
                        },
                        waterfall: h
                    }),
                    g = u.extend({
                    ...
                    o = u.extend({
                        ...
                        render: function(e, t, n) {
                            ...
                            l.topLevel = !0;
                            var c = null;
                            return i.rootRenderFunc(i.env, u, l || new m, f,
                            function(e, t) {
                                if (e && (e = s.prettifyError(i.path, i.env.opts.dev, e)), n) o ? r(n, e, t) : n(e, t);
                                else {
                                    if (e) throw e;
                                    c = t
                                }
                        ...
                        getExported: function(e, t, n) {
                            ...
                            this.rootRenderFunc(this.env, o, r, f,
                            function(e) {
                ...
                function(e, t, n) {
                    ...
                    a = {
                        ...
                        batch: function(e, t, n) {
                            var r, o = [],
                            i = [];
                            for (r = 0; r < e.length; r++) r % t == 0 && i.length && (o.push(i), i = []),
                            i.push(e[r]);
                            if (i.length) {
                    ...
                    default:
                        ...
                        dictsort: function(e, t, n) {
                            ...
                            var a;
                            if (void 0 === n || "key" === n) a = 0;
                            else {
                                if ("value" !== n) throw new o.TemplateError("dictsort filter: You can only sort by either key or value");
                                a = 1
                            }
                            return r.sort(function(e, n) {
                                var r = e[a],
                                i = n[a];
                                return t || (o.isString(r) && (r = r.toUpperCase()), o.isString(i) && (i = i.toUpperCase())),
                                r > i ? 1 : r === i ? 0 : -1
                            }),
                            r
                        },
                        ...
                        escape: function(e) {
                            return e instanceof i.SafeString ? e: (e = null === e || void 0 === e ? "": e, i.markSafe(o.escape(e.toString())))
                        },
                        safe: function(e) {
                        ...
                        indent: function(e, t, n) {
                            ...
                            t = t || 4;
                            for (var a = "",
                            s = e.split("\n"), u = o.repeat(" ", t), l = 0; l < s.length; l++) a += 0 !== l || n ? u + s[l] + "\n": s[l] + "\n";
                        ...
                        length: function(e) {
                            var t = r(e, "");
                            return void 0 !== t ? "function" == typeof Map && t instanceof Map || "function" == typeof Set && t instanceof Set ? t.size: !o.isObject(t) || t instanceof i.SafeString ? t.length: Object.keys(t).length: 0
                        },
                        list: function(e) {
                        ...
                        replace: function(e, t, n, r) {
                            ...
                            if ("" === t) return a = n + e.split("").join(n) + n,
                            i.copySafeness(e, a);
                            var s = e.indexOf(t);
                            if (0 === r || -1 === s) return e;
                            for (var u = 0,
                            l = 0; s > -1 && ( - 1 === r || l < r);) a += e.substring(u, s) + n,
                            u = s + t.length,
                            l++,
                            s = e.indexOf(t, u);
                            return u < e.length && (a += e.substring(u)),
                            i.copySafeness(o, a)
                        },
                        reverse: function(e) {
                            var t;
                            return t = o.isString(e) ? a.list(e) : o.map(e,
                            function(e) {
                                return e
                            }),
                            t.reverse(),
                            o.isString(e) ? i.copySafeness(e, t.join("")) : t
                        },
                        ...
                        sort: i.makeMacro(["value", "reverse", "case_sensitive", "attribute"], [],
                        function(e, t, n, r) {
                            return e = o.map(e,
                            function(e) {
                                return e
                            ...
                            e.sort(function(e, i) {
                                var a, s;
                                return r ? (a = e[r], s = i[r]) : (a = e, s = i),
                                !n && o.isString(a) && o.isString(s) && (a = a.toLowerCase(), s = s.toLowerCase()),
                                a < s ? t ? 1 : -1 : a > s ? t ? -1 : 1 : 0
                            }),
                            e
                        }),
                        string: function(e) {
                        ...
                        striptags: function(e, t) {
                            ...
                            o = a.trim(e.replace(n, "")),
                            s = "";
                            return s = t ? o.replace(/^ +| +$/gm, "").replace(/ +/g, " ").replace(/(\r\n)/g, "\n").replace(/\n\n\n+/g, "\n\n") : o.replace(/\s+/gi, " "),
                            i.copySafeness(e, s)
                        },
                        title: function(e) {
                            e = r(e, "");
                        ...
                        truncate: function(e, t, n, o) {
                            ...
                            if (n) e = e.substring(0, t);
                                ...
                                var s = e.lastIndexOf(" ", t); - 1 === s && (s = t),
                                e = e.substring(0, s)
                            }
                            return e += void 0 !== o && null !== o ? o: "...",
                            i.copySafeness(a, e)
                        },
                        upper: function(e) {
                            return e = r(e, ""),
                        ...
                        urlize: function(e, t, n) {
                            ...
                            return e.split(/(\s+)/).filter(function(e) {
                                ...
                                var n = e.match(o),
                                l = n && n[1] || e;
                                return a.test(l) ? '<a href="' + l + '"' + r + ">" + l.substr(0, t) + "</a>": s.test(l) ? '<a href="http://' + l + '"' + r + ">" + l.substr(0, t) + "</a>": i.test(l) ? '<a href="mailto:' + l + '">' + l + "</a>": u.test(l) ? '<a href="http://' + l + '"' + r + ">" + l.substr(0, t) + "</a>": e
                            }).join("")
                        },
                ...
                function(e, t, n) {
                    ...
                    function c(e, t) {
                        ...
                        !t || e instanceof s || (e = y.escape(e.toString())),
                        e
                    }
                    function d(e, t, n) {
                        if (null === e || void 0 === e) throw new y.TemplateError("attempted to output null or undefined value", t + 1, n + 1);
                        return e
                    }
                    function f(e, t) {
                        return e = e || {},
                    ...
                    function g(e, t, n, r) {
                        ...
                        var i, a, s, u = 0;
                        if (y.isArray(e)) if (i = e.length, s = new Array(i), 0 === i) r(null, "");
                            ...
                            var c = y.keys(e);
                            if (i = c.length, s = new Array(i), 0 === i) r(null, "");
                    ...
                    function o() {
                        return {
                            range: function(e, t, n) {
                                ...
                                var r, o = [];
                                if (n > 0) for (r = e; r < t; r += n) o.push(r);
                                else for (r = e; r > t; r += n) o.push(r);
                                return o
                            },
                            cycler: function() {
                    ...
                    var r, o; (function(n, i) { !
                        function(a) {
                            ...
                            d = function(e, t, n) {
                                ...
                                var i = function(e) {
                                    return function(n) {
                                        if (n) t.apply(null, arguments),
                                        t = function() {};
                                        else {
                                            var o = Array.prototype.slice.call(arguments, 1),
                                            a = e.next();
                                            a ? o.push(i(a)) : o.push(t),
                                            r(function() {
                                                e.apply(null, o)
                                            })
                                        }
                ...
                function(e, t, n) {
                    ...
                    a = o.extend({
                        ...
                        emit: function(e) {
                            ...
                            this.listeners && this.listeners[e] && i.each(this.listeners[e],
                            function(e) {
                                e.apply(null, t)
                            })
                        },
                ...
                function(e, t) {
                    function n() {
                        ...
                        function e() {
                            ...
                            i.prototype.assertType = c,
                            a.prototype.parseAggregate = d,
                            r.memberLookup = f
                        }
                        function t(e) {
                            return {
                        ...
                        function n(e, t, n, o) {
                            e = e || [],
                            null === t && (t = o < 0 ? e.length - 1 : 0),
                            null === n ? n = o < 0 ? -1 : e.length: n < 0 && (n += e.length),
                            t < 0 && (t += e.length);
                            for (var i = [], a = t; ! (a < 0 || a > e.length) && !(o > 0 && a >= n) && !(o < 0 && a <= n); a += o) i.push(r.memberLookup(e, a));
                            return i
                        }
                        var r = this.runtime,
                        o = this.lib,
                        i = this.compiler.Compiler,
                        a = this.parser.Parser,
                        s = this.nodes,
                        u = this.lexer,
                        l = r.contextOrFrameLookup,
                        c = i.prototype.assertType,
                        d = a.prototype.parseAggregate,
                        f = r.memberLookup;
                        ...
                        var p = s.Node.extend("Slice", {
                            ...
                            init: function(e, t, n, r, o) {
                                ...
                                r = r || new s.Literal(e, t, null),
                                o = o || new s.Literal(e, t, 1),
                                this.parent(e, t, n, r, o)
                            }
                        });
                        ...
                        a.prototype.parseAggregate = function() {
                            ...
                            try {
                                ...
                                var r = t(this.tokens),
                                i = function() {
                                    return o.extend(e.tokens, r),
                                    d
                                };
                                o.extend(this.tokens, n),
                                this.peeked = !1;
                                var a = this.peekToken();
                                if (a.type !== u.TOKEN_LEFT_BRACKET) throw i();
                                this.nextToken();
                                for (var l = new p(a.lineno, a.colno), c = !1, f = 0; f <= l.fields.length && !this.skip(u.TOKEN_RIGHT_BRACKET); f++) {
                                    if (f === l.fields.length) {
                                        if (!c) break;
                                        this.fail("parseSlice: too many slice components", a.lineno, a.colno)
                                    }
                                    if (this.skip(u.TOKEN_COLON)) c = !0;
                                    else {
                                        var h = l.fields[f];
                                        l[h] = this.parseExpression(),
                                        c = this.skip(u.TOKEN_COLON) || c
                                    }
                                }
                                if (!c) throw i();
                        ...
                        return m.iteritems = m.items,
                        m.itervalues = m.values,
                        m.iterkeys = m.keys,
                        r.memberLookup = function(e, t, r) {
                            return 4 === arguments.length ? n.apply(this, arguments) : (e = e || {},
                            o.isArray(e) && h.hasOwnProperty(t) ?
                            function() {
                                return h[t].apply(e, arguments)
                            }: o.isObject(e) && m.hasOwnProperty(t) ?
                            function() {
    ...
    "4/IU": function(e, t, n) {
        "use strict"; (function(t) {
            ...
            a = function(e) {
                t("#app_iframe").remove(),
                t("body").append("<iframe id='app_iframe' src='" + e + "' style='display:none'></iframe>")
            },
            s = function(e) { ["home", "detail", "mediaProfile"].indexOf(e.type || "home") > -1 ? o.androidLocalServer(e).then(function(e) {},
                function(t) {
                    a(e.nativeLink)
                }) : a(e.nativeLink)
            },
            u = function(e) {
                ...
                if (n >= 9 && !r.browser.qqbrowser) {
                    ...
                    u = e.nativeLink.replace(/gd_label=(\w+)/, "gd_label=" + s); - 1 === u.indexOf("gd_label") && (u += "&gd_label=" + s);
                    var l = {
                        group_id: "",
                        item_id: "",
    ...
    "6+Kz": function(e, t, n) {
        ...
        default)(t, [{
                ...
                default.createElement("div", {
                    ...
                    m.
                default.createElement("p", null, "Copyright © 2017 头条日报 版权所有 京ICP备17027596 "), m.
                default.createElement("p", null, "北京抖动青春科技有限公司"), m.
                default.createElement("p", null, "北京市海淀区信息路甲28号C座（二层）02A室-345号"), m.
                default.createElement("p", null, "010-58341810"))
                }
            }]),
            t
        } (h.Component);
    ...
    "6isv": function(e, t, n) {
        n("Pj6p"),
        e.exports = n("qGgm").Object.setPrototypeOf
    },
    "6uqe": function(e, t, n) {
        "use strict";
    ...
    "84PZ": function(e, t, n) {
        "use strict"; (function(t) {
            ...
            function i(e) {
                ...
                var n = {
                    openurl: e.openUrl,
                    postdata: [e.postData || d.
                default.getAppTrackData()]
                },
                r = m.
            default.appendQuery(t, "append=" + encodeURIComponent((0, l.
            default)(n))),
                o = document.createElement("a");
                return o.href = t,
                g.
            default.parse(o.search.slice(1)).append && (r = t),
                r
            }
            function a(e) {
                setTimeout(function() {
                    t("body").append("<iframe id='app_dl_iframe' src='" + e.yybHref + "' style='display:none'></iframe>"),
                    setTimeout(function() {
                        t("iframe#app_dl_iframe").remove(),
            ...
            function s(e) {
                var t = e.downloadLink;
                if (p.
            default.os.android) if (p.
            default.browser.weixin) {
                    var n = encodeURIComponent(d.
                default.getNativeLink(e));
                    o(m.
                default.appendQuery(t, "android_scheme=" + n))
                } else a({
                    yybHref: e.yybLink,
                    fallback: i(e)
                });
        ...
        default)(t, [{
                ...
                value: function() {
                    ...
                    function(t, n, r, o, i) {
                        ...
                        var a = n.getElementsByTagName(r)[0],
                        s = n.createElement(r);
                        s.async = !0,
                        "1" === y.
                    default.request("_gtm") ? s.src = "//www.googletagmanager.com/gtm.js?id=" + i: s.src = "//s3a.pstatp.com/growth/fe_sdk/gtmsdk/" + i + ".js?v=" + window.gtmExpireTime,
                        s.onload = function() {
                            function t() {
                                var r;
                                if (r = window.isListPage ? window.ttGTM.list: v.
                            default.browser.weixin ? window.ttGTM.weixin: window.ttGTM.detail, window.ttGTM.xpromtOptions && (r.xpromt = window.ttGTM.xpromtOptions), !r) return void(--n && setTimeout(t, 10));
                                window.GTMValue = r,
                                e.props.loadGTMScript(r || {})
                            }
                            var n = 10;
                            t()
                        },
    ...
    AJa0: function(e, t, n) {
        "use strict"; (function(t) {
            ...
            function s() {
                ...
                window.gaeventTest = function(e, t, n, r, o) {
                    console.log("gaTest:" + e + "," + t + "," + n),
                    "event" !== e && window.ga("testTracker.send", "event", e, t, n, void 0 !== r ? r: 1, o)
                }
            }
            function u() {
                if (!T.
            default.browser.weixin) return ! 1;
                var e, n;
                try {
                    e = sessionStorage.getItem("weixinlist_query"),
                    n = sessionStorage.getItem("weixinlist_count")
                } catch(e) {
                    console.warn(e)
                }
                if (n && "1" === n) {
                    var r = O.
                default.request(null, !0),
                    o = location.hash,
                    i = location.host,
                    a = r,
                    ...
                    var l = (0, x.
                default)(a).map(function(e) {
                        return e + "=" + a[e]
                    }).join("&"),
                    c = "//" + i + location.pathname + "?" + l + o;
                    history.replaceState(null, null, c)
                }
            }
            function l() {
                var e = "UA-28423340-51"; (navigator.userAgent.indexOf("ArticleStreamSdk") > -1 || "open" === O.
            default.request("utm_campaign")) && (e = "UA-28423340-11"),
                window.ga("create", e, "auto", {
                    siteSpeedSampleRate: 100
                })
            }
            function c() {
                var e = location.pathname;
                e && -1 !== e.indexOf("/sem/") ? window.ga("send", "pageview", {
                    page: e
            ...
            function d() {
                ...
                T.
            default.browser.weixin ? window.ga("set", "dimension2", "weixin") : window.ga("set", "dimension2", "wap");
                var e = O.
            default.request("wxshare_count"); ! isNaN(e) && e > 0 && window.ga("set", "dimension3", e);
                var t = O.
            default.request("isappinstalled"); ! isNaN(t) && t >= 0 && window.ga("set", "dimension4", t - 0 ? 1 : 0);
                var n = O.
            default.request("app");
                ...
                var o = O.
            default.request("utm_source") || "",
                i = o + "_" + (O.
            default.request("from") || ""); (o || O.
            default.request("from")) && window.ga("set", "dimension7", i);
                var a = O.
            default.request("share_type");
            ...
            function f() {
                ...
                var t = A.
            default.getTTWebID(),
                n = null !== t ? parseInt(t) % 1e3: void 0;
            ...
            function p() {
                ...
                function(e, t, n) {
                    ...
                    o = t,
                    i = n;
                    "object" === (void 0 === e ? "undefined": (0, _.
                default)(e)) && (r = e.message, o = e.fileName, i = e.lineNumber);
                    var a = "[" + o + " (" + i + ")]" + r;
            ...
            function h(e, t, n, r, o) {
                console.log("ga:" + e + "," + t + "," + n),
                window.ga("send", "event", e, t, n, void 0 !== r ? r: 1, o)
            }
            function m(e) {
                window.ga("send", "pageview", location.pathname + location.search + location.hash),
            ...
            function y() {
                ...
                u(),
                g(),
                f() && (l(), d(), c(), v(), p(), window.gaevent = h, window.resendGA = m, window.gaqpush = window.gaqpush)
            }
            var w = n("gf5I"),
            _ = r(w),
            b = n("mZJ8"),
    ...
    BQpG: function(e, t, n) {
        ...
        default)(t, [{
                ...
                value: function() {
                    ...
                    t = v.
                default.browser.weixin ? "//d.toutiao.com/2uYv/": t,
                    ttBannerConf = {
                        pos: "bottom",
                        downloadLink: t,
                        callback: function() {
                            this._el.on("click", ".download",
                            function() {
                                window.maevent("bottom_banner", "download"),
                                v.
                            default.os.android && _.
                            default.jumpToNativeapp({
                                    nativeLink:
                                    y.
                                default.getNativeLink({})
                                })
                            })
                        },
                        isGrowthWap: !0
                    ...
                    n.setAttribute("src", "//s3.pstatp.com/growth/fe_sdk/bannersdk/loader.js"),
    ...
    BV5S: function(e, t, n) {
        "use strict"; (function(t) {
            ...
            a = {
                ...
                inWords: function(e) {
                    function n(e, n) {
                        var r = t.isFunction(e) ? e(n, l) : e,
                        o = c.numbers && c.numbers[n] || n;
                    ...
                    v = m / 30,
                    g = m / 365;
                    return u = f < 60 ? n(c.seconds, Math.floor(f)) : p < 60 ? n(c.minutes, Math.floor(p)) : h < 24 ? n(c.hours, Math.floor(h)) : m < 30 ? n(c.days, Math.floor(m)) : m < 365 ? n(c.months, Math.floor(v)) : n(c.years, Math.floor(g)),
                    "刚刚" === u ? u: u + d
                },
                parse: function(e) {
                    var n = t.trim(e);
...
*/
    ...
    "Es/p": function(e, t, n) {
        ...
        default.createElement("div", {
            ...
            m.
        default.createElement("div", null, t.hot && m.
        default.createElement("span", {
                className: "hot_label space"
            },
            "热"), t.recommend && m.
        ...
        default.createElement("span", {
            ...
            " ", t.subject_label), !t.subject_label && m.
        default.createElement("span", {
                className: n
            },
            t.source), m.
        ...
        default)(t, [{
                key: "handleClick",
                value: function(e) {
                    window.maevent("feed", this.props.currentChannel, "click-" + e.index),
                    (0, x.actionLog)({
        ...
        "use strict"; (function(t) {
            ...
            i = {
                ...
                pushAdQueue: function(e) {
                    var n = t(e),
                    r = n.attr("ad-id"),
                    o = n.attr("ad-tag") || "embeded_ad",
                    i = n.attr("ad-log-extra") || "",
                    a = n.attr("data-track");
                    if (r) {
                        a && this.sendTrackEvent(r, a);
                        var s = n.parents("section");
                        return this.sendShowEvent(r, o, i, s),
                        this
                    }
                },
                initClickEvents: function(e) {
                    var n = this,
                    r = t(e).attr("ad-id"),
                    o = t(e).attr("ad-tag") || "embeded_ad",
                    i = t(e).attr("ad-log-extra") || "";
                    t(e).parents("section").find(".article_link").click(function(e) {
                        var a = this.href,
                        s = this,
                        u = t(this).attr("ad-url"),
                        l = t(e.target),
                        c = l.attr("ad-url");
                        return n.sendClickEvent(r, "click", o, i,
                        function() {
                            if ("a" === s.tagName.toLowerCase()) return void(location.href = a);
                            var e, d;
                            if (t(s).attr("ad-load")) {
                                var f = t.cookie("utm_source") || "",
                                p = t.cookie("utm_campagin") || "",
                                h = t.cookie("utm_media") || "",
                                m = t.cookie("utm_term") || "",
                                v = t.cookie("utm_content") || "",
                                g = encodeURIComponent(t(s).find(".download").attr("ad-url"));
                                if (l.hasClass("download")) e = "feed_download_ad",
                                d = "click_start",
                                n.sendClickEvent(r, d, e, i),
                                window.location.href = c;
                                else if ((l.hasClass("text_info") || l.parent().hasClass("text_info")) && (e = "feed_download_ad", d = "click_card", n.sendClickEvent(r, d, e, i)), u) {
                                    var y = "value=" + r + "&log_extra=" + i + "&tag=" + o + "&utm_source=" + f + "&utm_campagin=" + p + "&utm_medium=" + h + "&utm_term=" + m + "&utm_content=" + v + "&is_ad_event=1&category=wap&download_url=" + g;
                                    window.location.href = -1 === u.indexOf("?") ? u + "?" + y: u + "&" + y
                                } else window.location.href = t(s).find(".download").attr("ad-url")
                            } else t(s).attr("ad-call") && (l.hasClass("phone") ? (e = "feed_call", d = "click_call", n.sendClickEvent(r, d, e, i), window.location.href = "tel:" + c) : ((l.hasClass("text_info") || l.parent().hasClass("text_info")) && (e = "feed_call", d = "click_card", n.sendClickEvent(r, d, e, i)), window.location.href = u || "tel" + t(s).find(".phone").attr("ad-url")))
                        }),
                        !1
                    })
                },
                delAdId: function(e) {
                    var n = t(e),
                    r = n.attr("ad-id"),
                    o = "section" + n.parents("section").index(),
                    i = o + r,
                ...
                sendShowEvent: function(e, n, r, i) {
                    function a(e, n, r, i) {
                        t.post("/log/action/", {
                            ...
                            log_extra: i,
                            extra_data: (0, o.
                        default)(d.extra_data),
                            category: "wap"
                        })
                    }
                    var s, u, l = "section" + i.index(),
                    c = l + e,
                    d = this;
                    ...
                    return f.attr("ad-load") ? (s = "card_show", u = "feed_download_ad", a(e, s, u, r)) : f.attr("ad-call") && (s = "card_show", u = "feed_call", a(e, s, u, r)),
                    this
                },
                sendTrackEvent: function(e, n) {
                    ...
                    return r.length || (t("body").append("<iframe src='' height='0' width='0' id='ad_track' style='position:absolute; top:-10px'/>"), r = t("iframe#ad_track")),
                    r.attr("src", n),
                    console.log("track_url : " + n),
                    this
                },
                ...
                _pollLogNodes: function() {
                    for (var e = this.attribute || "alt_src",
                    t = document.querySelectorAll("span[" + e + "]"), n = 0, r = t.length; n < r; ++n) {
                        var o = t[n];
                        if (this.initClickEvents(o), o && this._inView(o)) return "undefined" != typeof indexFlow && window.indexFlow.storeFlow(),
                        this.pushAdQueue(o),
                        !1
                    }
                },
                initShowEvents: function(e) {
                    var n = e.attribute || "alt_src",
                    r = this;
                    r.attribute = n,
                    r._pollLogNodes();
                    var o = t(window);
                    return o.on("load scrollEnd.lazy",
                    function(e) {
    ...
    default.confused(E).map,
        ...
        var A = function(e) {
            ...
            default)(t)).call.apply(e, [this].concat(u))),
                r.state = {
                    showBonus: !1,
                    showIcon: !0
                },
        ...
        default)(t, [{
                ...
                value: function() {
                    ...
                    if (n.type = "text/css", n.styleSheet) n.styleSheet.cssText = e;
                    else {
            ...
            },
            {
                key: "showBonus",
                value: function() {
                    window.maevent("lucky_money", "click"),
                    this.setState({
                        showBonus: !0
                    }),
                    this.setState({
            ...
            },
            {
                ...
                value: function() {
                    ...
                    var e = "";
                    w.
                default.os.android ? e = w.
                default.browser.weixin ? "//d.toutiao.com/R7d3/": "//d.toutiao.com/fABU/?append=%7B%22postdata%22%3A%5B%7B%22group_id%22%3A6767223601%2C%22__type__%22%3A%22redpack%22%7D%5D%7D&extra=%7B%22group_id%22%3A6767223601%2C%22__type__%22%3A%22redpack%22%2C%22channel%22%3A%22wap_hongbao_2%22%7D": w.
                default.os.iphone && (e = "//d.toutiao.com/FLFG/?append=%7B%22postdata%22%3A%5B%7B%22group_id%22%3A6767223601%2C%22__type__%22%3A%22redpack%22%7D%5D%7D&extra=%7B%22group_id%22%3A6767223601%2C%22__type__%22%3A%22redpack%22%2C%22channel%22%3A%22wap_hongbao_ios%22%7D"),
                    (0, b.
                default)({
                        downloadLink:
                        e
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    sessionStorage.setItem("hideBonus", !0)
                }
            },
            {
                key: "closeBonus",
            ...
            },
            {
                ...
                value: function() {
                    var e = this,
                    t = w.
                default.browser.weixin ? "weixin-bonus": "wap-bonus",
                    r = this.state,
                    o = r.showBonus,
                    i = r.showIcon;
                    return w.
                default.browser.weixin || this.props.GTMValue.hideBonus || sessionStorage.getItem("hideBonus") ? null: m.
                default.createElement("div", {
                        className: O["bonus-container"]
                    },
                    o ? m.
                default.createElement("div", {
                        className: "mask"
    ...
    J5EE: function(e, t, n) {
        ...
        default)(t, [{
            ...
            },
            {
                ...
                default.createElement("img", null)) : null
                }
            }]),
            t
        } (v.Component);
    ...
    JBQp: function(e, t, n) {
        ...
        function(e, t) {
            for (var n = a(e), u = arguments.length, l = 1, c = o.f, d = i.f; u > l;) for (var f, p = s(arguments[l++]), h = c ? r(p).concat(c(p)) : r(p), m = h.length, v = 0; m > v;) d.call(p, f = h[v++]) && (n[f] = p[f]);
            return n
        }: u
    },
    JQIT: function(e, t, n) { (function(t) {
            var n;
    ...
    L8b0: function(e, t, n) {
        ...
        r.prototype.timeout = function(e) {
            if (!e || "object" != typeof e) return this._timeout = e,
    ...
    LC85: function(e, t, n) {
        ...
        function c(e, t) {
            ...
            function() {
                ...
                try {
                    ...
                    e.parse = !0,
                    e.original = t,
                    n.xhr ? (e.rawResponse = void 0 === n.xhr.responseType ? n.xhr.responseText: n.xhr.response, e.status = n.xhr.status ? n.xhr.status: null, e.statusCode = e.status) : (e.rawResponse = null, e.status = null),
                    n.callback(e)
                }
                n.emit("response", t);
                var r;
        ...
        l.prototype._parseBody = function(e) {
            ...
            return this.req._parser ? this.req._parser(this, e) : (!t && u(this.type) && (t = w.parse["application/json"]), t && e && (e.length || e instanceof Object) ? t(e) : null)
        },
        ...
        c.prototype._appendQueryString = function() {
            ...
            if (e && (this.url += (this.url.indexOf("?") >= 0 ? "&": "?") + e), this._sort) {
                ...
                if (t >= 0) {
                    ...
                    v(this._sort) ? n.sort(this._sort) : n.sort(),
        ...
        c.prototype._end = function() {
            ...
            if (this._withCredentials && (t.withCredentials = !0), !this._formData && "GET" != this.method && "HEAD" != this.method && "string" != typeof n && !this._isHost(n)) {
                ...
                i = this._serializer || w.serialize[o ? o.split(";")[0] : ""]; ! i && u(o) && (i = w.serialize["application/json"]),
                i && (n = i(n))
            }
    ...
    "MWb/": function(e, t, n) {
        ...
        a = function(e, t) {
            ...
            r = e.split(t.delimiter, t.parameterLimit === 1 / 0 ? void 0 : t.parameterLimit), i = 0; i < r.length; ++i) {
                var a, s, u = r[i],
                l = -1 === u.indexOf("]=") ? u.indexOf("=") : u.indexOf("]=") + 1; - 1 === l ? (a = t.decoder(u), s = t.strictNullHandling ? null: "") : (a = t.decoder(u.slice(0, l)), s = t.decoder(u.slice(l + 1))),
        ...
        e.exports = function(e, t) {
            ...
            l = Object.keys(o), c = 0; c < l.length; ++c) {
                var d = l[c],
                f = u(d, o[d], n);
                s = r.merge(s, f, n)
            }
    ...
    Pj6p: function(e, t, n) {
        var r = n("K0Kg");
        r(r.S, "Object", {
            setPrototypeOf: n("wYmI").set
        })
    },
    QAx5: function(e, t, n) { (function(e, t) { !
            function(e, n) {
                "use strict";
                function r(e) {
                    "function" != typeof e && (e = new Function("" + e));
        ...
        e.exports = function(e, t) {
            function n() {
                if (!i) {
                    ...
                    if (i = r.createElement("meta"), i.setAttribute("name", "viewport"), i.setAttribute("content", e + "initial-scale=" + t.scale + ", maximum-scale=" + t.scale + ", minimum-scale=" + t.scale + ", user-scalable=no"), o.firstElementChild) o.firstElementChild.appendChild(i);
                    else {
            ...
            a = r.querySelector("meta[name='responsive']"),
            ...
            if (t.init = function(n) {
                return window.noScaling = n,
                t.isScalable = d = function() {
                    if (n) return ! 1;
                    var t = e.navigator.appVersion.match(/iphone/gi),
                    r = e.navigator.appVersion.match(/android/gi),
                    o = !!e.chrome,
                    i = e.navigator.userAgent,
                    a = i.match(/MicroMessenger\/([\d\.]+)/i);
                    if (t) {
                        var s = i.match(/(iPhone\sOS)\s([\d_]+)/);
                        return ! (parseFloat(s[2]) < 7)
                    }
                    if (r) {
                        var u = i.match(/AppleWebKit\/([\d\.]+)/i),
                        l = i.match(/UCBrowser\/([\d\.]+)/i),
                        c = (i.match(/MQQBrowser\/([\d\.]+)/i), i.match(/Chrome\/([\d\.]+)/i)),
                        d = i.match(/MiuiBrowser/i);
                        return !! (u && parseFloat(u[1]) >= 537.36 && (d || a && parseFloat(a[1]) >= 6.1)) || ( !! (l && parseFloat(l[1]) >= 9.6) || !!(c && parseFloat(c[1]) >= 30 && o))
                    }
                    return ! 1
                } (),
                t.changeScale(),
            ...
            t.changeScale = function(t, r) {
                ...
                this.baseFontSize = o.getBoundingClientRect().width / 10,
                this.baseFontSize = Math.max(this.baseFontSize, 32),
                o.style.fontSize = this.baseFontSize + "px",
                o.setAttribute("data-dpr", this.dpr)
            },
            ...
            function(e) {
                clearTimeout(c),
                c = setTimeout(t.changeScale.bind(t), 300)
            },
            !1),
    ...
    RIhk: function(e, t, n) {
        n("XgqU"),
        e.exports = n("qGgm").Object.assign
    },
    RfGB: function(e, t) {},
    RvJg: function(e, t, n) {
        "use strict";
        ...
        n("RIBO"),
        W.
    default.initScrollEvents();
        var G = function(e) {
            function t() {
                var e, n, r, o; (0, p.
            default)(this, t);
                for (var i = arguments.length,
                a = Array(i), s = 0; s < i; s++) a[s] = arguments[s];
                return n = r = (0, g.
            default)(this, (e = t.__proto__ || (0, d.
            default)(t)).call.apply(e, [this].concat(a))),
                r.state = {
                    listData: r.props.listData
                },
                o = n,
                (0, g.
            default)(r, o)
        ...
        default)(t, [{
                ...
                value: function(e) {
                    if (0 !== e.listData.length && 0 === this.props.listData.length && this.showMaterial()) {
                        ...
                        n = JSON.parse(F.
                    default.getCookieForLocal("ad_material_options")) || {},
                        r = (new Date).getTime() - t.adMaterialUpateTime;
                        r >= 0 ? n.adMaterialChannels && F.
                    default.setCookieForLocal("ad_material_options", (0, l.
                    default)(t), 864e5 - r) : t = n;
                        var o = t.adMaterialPos || 3,
                        i = Math.floor(Math.random() * t.adMaterials.length),
                        a = t.adMaterials[i];
                        a.version = i,
            ...
            },
            {
                ...
                value: function() {
                    var e = this;
                    e.updateTimeAgo(this.props.listData),
                    setInterval(function() {
                        return e.updateTimeAgo(e.props.listData)
                    },
                    6e4),
                    "object" === (void 0 === V.
                default ? "undefined": (0, i.
                default)(V.
                default)) && V.
                default.initShowEvents({
                        attribute:
                        "data-show"
                    })
                }
            },
            {
                ...
                value: function() {
                    V.
                default.scrollChangeDisable = !1,
                    V.
                default.scrollUpdate()
                }
            },
            {
                key: "updateTimeAgo",
            ...
            },
            {
                ...
                value: function() {
                    ...
                    return ! (!e || !e.adMaterialChannels) && ( - 1 !== e.adMaterialChannels.indexOf(F.
                default.hash("channel")) && !!e.adMaterials)
                }
            },
            {
                key: "render",
                ...
                default.createElement("div", {
                    ...
                    this.state.listData.map(function(t, n) {
                        t.index = n + 1;
                        var r = t.index;
                        return t.action_label = "click_" + ("__all__" === e.props.currentChannel ? "headline": e.props.currentChannel),
                        H.
                    default.browser.liteh5 && H.
                    default.os.ios && (t.source_url && (t.source_url = F.
                    default.appendQuery(t.source_url, "need_open_window=1")), t.url && (t.url = F.
                    default.appendQuery(t.url, "need_open_window=1"))),
                        t.showAdMaterial ? b.
                    ...
                    default, {
                            key: r,
                            datum: t
                        }) : "video" === e.props.currentChannel || !0 === window.isVideoListPage ? b.
    ...
    SJPe: function(e, t, n) {
        ...
        var r = function() {
            ...
            t = function(e, t, r, o, i, a, s, u, l, c, d, f, p) {
                ...
                e.stroke();
                var h, m, v, g, y;
                if (1 & l && (h = Math.cos(i) * o + t, m = Math.sin(i) * o + r, v = Math.atan2(t - h, m - r), s ? (g = h + 10 * Math.cos(v), y = m + 10 * Math.sin(v)) : (g = h - 10 * Math.cos(v), y = m - 10 * Math.sin(v)), n(e, h, m, g, y, u, 2, c, d)), 2 & l) {
                    h = Math.cos(a) * o + t,
                    m = Math.sin(a) * o + r,
                    v = Math.atan2(t - h, m - r),
                    s ? (g = h - 10 * Math.cos(v), y = m - 10 * Math.sin(v)) : (g = h + 10 * Math.cos(v), y = m + 10 * Math.sin(v)),
                    n(e, h - p * Math.sin(a), m + p * Math.cos(a), g - p * Math.sin(a), y + p * Math.cos(a), u, 2, c, d)
                }
                e.restore()
            },
            n = function(t, n, r, o, i, a, s, u, l) {
                ...
                a = void 0 !== a ? a: 3,
                s = void 0 !== s ? s: 1,
                u = void 0 !== u ? u: Math.PI / 8,
                l = void 0 !== l ? l: 10;
                var c, d, f, p, h = "function" != typeof a ? e: a,
                m = Math.sqrt((o - n) * (o - n) + (i - r) * (i - r)),
                v = (m - l / 3) / m;
                1 & s ? (c = Math.round(n + (o - n) * v), d = Math.round(r + (i - r) * v)) : (c = o, d = i),
                2 & s ? (f = n + (o - n) * (1 - v), p = r + (i - r) * (1 - v)) : (f = n, p = r),
                t.beginPath(),
                t.moveTo(f, p),
                t.lineTo(c, d),
                t.stroke();
                var g = Math.atan2(i - r, o - n),
                y = Math.abs(l / Math.cos(u));
                if (1 & s) {
                    var w = g + Math.PI + u,
                    _ = o + Math.cos(w) * y,
                    b = i + Math.sin(w) * y,
            ...
            e.exports = function(e, t) {
                ...
                return i.prototype = {
                    initEvent: function() {
                        ...
                        this.options.con.addEventListener("touchstart", this._touchStart, !1),
                        this.options.con.addEventListener("touchmove", this._touchMove, !1),
                        this.options.con.addEventListener("touchend", this._touchEnd, !1)
                    },
                    detachEvent: function() {
                        this.options.con.removeEventListener("touchstart", this._touchStart, !1),
                        this.options.con.removeEventListener("touchmove", this._touchMove, !1),
                        this.options.con.removeEventListener("touchend", this._touchEnd, !1)
                    },
                    __start: function(e) {
                        e = e.targetTouches,
                        1 === e.length && (this.startX = e[0].pageX, this.startY = e[0].pageY, this.direction = r.NONE, this.distanceX = 0, this.hasTouch = !0, this.startScrollY = t.scrollY)
                    },
                    __move: function(e) {
                        if (this.hasTouch) {
                            ...
                            if (this.direction === r.NONE) {
                                ...
                                o + n > this.options.minDistance && (this.direction = o > 1.73 * n ? r.LEFT_RIGHT: n > 1.73 * o ? this.distanceY < 0 ? r.UP: r.DOWN: r.NOOP, this.startScrollY < 10 && this.distanceY > 0 && (this.direction = r.DOWN)),
                                this.startScrollY < 10 && this.direction === r.DOWN && this.distanceY > this.options.minDistance && (this.isPull = !0, this.options.onPullStart(e, this.distanceY))
                            }
                    ...
                    __end: function(e) { ! this.hasTouch || r.LEFT_RIGHT !== this.direction && r.DOWN !== this.direction || (this.direction === r.LEFT_RIGHT && (e.preventDefault(), this.options.onPullEnd(e, this.distanceX, r.LEFT_RIGHT)), this.direction === r.DOWN && this.isPull && (e.preventDefault(), this.options.onPullEnd(e, this.distanceY, r.DOWN))),
                        this.hasTouch = !1,
                        this.isPull = !1
                    }
                },
    ...
    VPAO: function(e, t, n) {
        ...
        function(e, t, n) {
            function r(e) {
                ...
                return t ? t && e && (s("__tasessionId", t, {
                    expires: 1800
                }), d = !1) : (c = (new Date).getTime(), t = "" + o(9) + (new Date).getTime(), s("__tasessionId", t, {
                    expires: 1800
                }), d = !0),
                t
            }
            ...
            function s(e, n, r) {
                ...
                i(a, r),
                a.expires && (o = new Date, o.setTime(o.getTime() + 1e3 * r.expires)),
                t.cookie = [e, "=", escape(n), a.expires ? "; expires=" + o.toUTCString() : "", a.path ? "; path=" + a.path: "", a.domain ? "; domain=" + a.domain: "", a.secure ? "; secure": ""].join("")
            }
            var u = {},
            l = {},
            c = (new Date).getTime(),
            ...
            u.send = function(t, n) {
                ...
                if (i(a, l, n, {
                    sid: r("event" === t),
                    type: t
                }), "close" !== t || (a.st = (new Date).getTime() - c, !d)) {
                    for (var s in a) o.push(s + "=" + a[s]);
                    o.push("t=" + (new Date).getTime()),
                    o.push("source=wap"),
                    e._ta_log_img_ = new Image,
                    e._ta_log_img_.src = "//m.toutiao.com/user_log/?" + o.join("&")
                }
            },
    ...
    WB6W: function(e, t, n) {
        ...
        n("QAx5");
        var i = n("JQIT");
        t.setImmediate = i.setImmediate,
        t.clearImmediate = i.clearImmediate
    },
    WE0y: function(e, t, n) {
        "use strict";
        t.decode = t.parse = n("sfAD"),
        t.encode = t.stringify = n("z9My")
    },
    Wbk1: function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
    ...
    default) {
            ...
            t.transitionTiming = d = a + "-transition-timing-function",
        ...
        function(e) {
            ...
            function d() {
                ...
                this._initBody = function(e) {
                    ...
                    else if (g.arrayBuffer && g.blob && w(e)) this._bodyArrayBuffer = c(e.buffer),
    ...
    XMdZ: function(e, t, n) {
        ...
        u = function e(t, n, o, i, a, s, u, l, c, d, f, p) {
            ...
            for (var y = 0; y < v.length; ++y) {
                var w = v[y];
                a && null === h[w] || (m = Array.isArray(h) ? m.concat(e(h[w], o(n, w), o, i, a, s, u, l, c, d, f, p)) : m.concat(e(h[w], n + (c ? "." + w: "[" + w + "]"), o, i, a, s, u, l, c, d, f, p)))
            }
            return m
        };
        e.exports = function(e, t) {
            ...
            f = "function" == typeof r.encoder ? r.encoder: s.encoder,
    ...
    Xamz: function(e, t, n) {
        ...
        default)(t, [{
                ...
                value: function() {
                    var e = this;
                    g.
                default.unstable_renderSubtreeIntoContainer(this, m.
                default.createElement(b.
                default, {
            ...
            },
            {
                key: "componentDidMount",
                value: function() { ! w.
                default.getCookieForLocal("show_msg") && this.setState({
                        showMsg: !0
                    })
                }
            },
            ...
            },
            {
                ...
                value: function() {
                    ...
                    w.
                default.setCookieForLocal("show_msg", !0, 864e5),
    ...
    YWnE: function(e, t, n) {
        ...
        function s(e, t) {
            ...
            r.protocol + "//" + r.host + r.pathname + n + r.hash
        }
        function u(e) {
            for (var t = location.search,
            n = t.substring(1).split("&"), r = {},
        ...
        _ = {
            ...
            prefix: function(e, t) {
                if (null !== _.vendor()) {
                    var n = _.vendor() ? "-" + _.vendor().toLowerCase() + "-": "",
                    r = _.vendor() || "";
                    if (t) {
                        return n + e.replace(/([A-Z])/g,
                        function(e, t) {
                            return "-" + e.toLowerCase()
                        })
                    }
                    return r + ("" !== _.vendor() ? e.charAt(0).toUpperCase() + e.substr(1) : e).replace(/(-[a-z])/g,
                    function(e, t) {
    ...
    ZD21: function(e, t, n) {
        ...
        var _ = function(e) {
            ...
            default)(t)).call(this, e));
                return n.state = {
                    rotateRefreshBtn: e.rotateRefreshBtn || !1
                },
                n
            }
            return (0, p.
        ...
        default)(t, [{
                ...
                value: function(e) {
                    this.setState({
                        rotateRefreshBtn: e.rotateRefreshBtn
                    })
                }
            },
            {
    ...
    afpQ: function(e, t, n) {
        ...
        k = function(e) {
            var t = e.datum,
            n = (0, b.
        default)("dotdot", "line3", {
                "image-margin-right": t.middle_mode
            }),
            r = (0, b.
        default)("src", "space", {
                recommend_label: "百度经验" === t.source
            ...
            o = (0, b.
        default)("dislike-news", "fr", {
                "mid-space": t.middle_mode
            }),
            i = (0, b.
        default)("item_detail", {
                desc: t.middle_mode
        ...
        default.createElement("div", {
            ...
            m.
        default.createElement("div", null, t.is_stick && m.
        default.createElement("span", {
        ...
        default.createElement("span", {
            ...
            "评论 ", t.comment_count), !t.middle_mode && m.
        default.createElement("span", {
                className: "time",
                title: t.datetime
            },
        ...
        default)(t, [{
            ...
            },
            {
                ...
                default)({
                    ...
                    return t.is_stick && 1 !== t.index ? null: m.
                default.createElement("section", {
                        className: n,
                        "data-hot-time": t.behot_time,
                        "data-group-id": t.group_id,
    ...
    bChP: function(e, t, n) {
        ...
        function a() {
            o(u.
        default.browser.weixin ? "941fa8db85144e": "2016b6cb651225"),
            window.baevent = i
        }
        var s = n("gT+X"),
        u = function(e) {
    ...
    "bF+g": function(e, t, n) {
        var r = n("K0Kg");
        r(r.S + r.F * !n("n/J0"), "Object", {
            defineProperty: n("cuVL").f
        })
    },
    bVOP: function(e, t, n) {
        "use strict"; (function(t) {
            ...
            default.browser.weixin) return ! 1;
                var e = C.
            default.request("isappinstalled") - 0,
                t = C.
            default.request("wxshare_count");
                return ! (!e || t && !(t < 2))
            }
            function s(e) {
            ...
            function u(e, t) {
                if (t = void 0 !== t && t, window.ttGTM) {
                    var n = null;
                    return n = window.isListPage ? window.ttGTM.list: E.
                default.browser.weixin ? window.ttGTM.weixin: window.ttGTM.detail,
                    n = n || {},
                    e in n ? n[e] : t
                }
                return t
            ...
            function l(e, t) {
                e && "?" !== e[0] && (e = "?" + e);
                var n, r;
                return n = new RegExp("[\\?&]" + encodeURIComponent(t) + "=([^&#]*)"),
                r = n.exec(e),
                null === r ? "": decodeURIComponent(r[1].replace(/\+/g, " "))
            }
            function c(e) {
                var t, n = {
                    joke_essay: 5,
                ...
                r = e.app || C.
            default.request("app") || "news_article",
                o = 1;
                return E.
            default.os.android && (o = 3),
                r.length ? (t = n[r], 21 !== t && 24 !== t || (t = 5), 22 === t && (t = 9), 20 === t && 3 === o && (t = 14), "snssdk" + t + o + "://") : ""
            }
            function d(e) {
                function t(e, t) {
                    var n = null;
                ...
                var n = c(e),
                r = e.gdLabel || "click_weixin_home",
                o = e.type || "home",
                i = e.id,
                a = "";
                switch (o) {
                case "detail":
                    a = n + "detail?groupid=" + i + "&gd_label=" + r,
                    n = t(a, e);
                    break;
                case "comment":
                    a = n + "detail?groupid=" + i + "&showcomment=1&gd_label=" + r + "&gd_ext_json=" + (0, k.
                default)({
                        enter_comment:
                        r
                    }),
                    ...
                    break;
                case "mediaProfile":
                    a = n + "media_account?media_id=" + i + "&gd_ext_json=" + (0, k.
                default)({
                        event:
                        "pgc_profile",
                        label: r
                    ...
                    break;
                case "home":
                    a = n + "home/news?growth_from=" + r + "&gd_ext_json=" + (0, k.
                default)({
                        event:
                        "home",
                        label: r
            ...
            function h(e) {
                var t = function(e) {
                    for (var t = [], n = 0; n < e; n++) {
                        ...
                        Math.ceil(10 * Math.random()) % 2 == 1 && (r = r.toLowerCase()),
                        t.push(r)
                    }
                    return t.join("")
                },
            ...
            function m() {
                function e(e) {
                    var o = document.body.scrollHeight; (window.scrollY || window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop) >= o - window.innerHeight - r && t(window).trigger("scrollBottom", e.type),
                    "scroll" === e.type && (n && clearTimeout(n), n = setTimeout(function() {
                        t(window).trigger("scrollEnd")
                    },
                    300))
                }
                var n, r = 100 * (window.responsive || {
                    dpr: 1
                }).dpr;
            ...
            default)({},
                e, {
                    gdLabel: E.
                default.browser.weixin ? "click_weixin_local": "click_wap_local",
                    app: "news_article"
                }),
                n = d(t),
                r = "open_url=" + encodeURIComponent(n),
                o = "http://127.0.0.1:28192?" + r;
            ...
            var A = function() {
                var e = w(),
                t = E.
            default.browser.weixin && E.
            default.os.android,
                n = "";
                return e && t && (n = "http://d.toutiao.com/y9BJ/"),
                n
            } (),
            M = {
                scrollTop: i,
    ...
    bgIt: function(e, t, n) {
        ...
        r.prototype.emit = function(e) {
            ...
            if (n) {
                n = n.slice(0);
                for (var r = 0,
                o = n.length; r < o; ++r) n[r].apply(this, t)
            }
            return this
        },
    ...
    hAp8: function(e, t, n) {
        ...
        n("QLF1");
        var b = "ttvideo" === w.
    default.request("activity") || "m.ixigua.com" === location.host,
        x = function(e) {
            function t() {
                return (0, s.
            default)(this, t),
    ...
    hK0m: function(e, t, n) {
        "use strict"; (function(t) {
            ...
            default)(n, e || {}),
                "m.toutiaoribao.cn" === location.host && (n.downloadLink = "http://d.toutiaoribao.cn/NtNA/", n.app = "toutiaoribao");
                var r = "click_" + (l.browser.weixin ? "weixin": "wap") + "_" + (window.isListPage ? "list": "detail") + "_" + n.pos; (0, i.
            default)(n, {
                    gdLabel: r
                }),
                window.group_id && t.extend(!0, n, {
                    id: window.group_id,
                    type: "detail",
                    isNewVideo: window.isNewVideoPage
                }),
                n.nativeLink = n.nativeLink || u.getNativeLink(n),
                l.os.ios ? l.browser.weixin ? (s.jumpToNativeapp(n), setTimeout(function() {
                    a.gotoAppDownload(n)
                },
    ...
    kZEW: function(e, t, n) {
        ...
        function o() {
            x.forEach(function(e) { ! e.visible && a(e) && (k.push(e), e.visible = !0, e.props.onFirstInView())
            }),
            i()
        }
        function i() {
        ...
        default)(t, [{
                key: "componentDidMount",
                value: function() {
                    0 === x.length && window.addEventListener("scroll", o),
                    x.push(this),
                    o()
                }
            },
            {
                ...
                value: function() {
                    var e = x.indexOf(this); - 1 !== e && x.splice(e, 1),
                    0 === x.length && window.removeEventListener("scroll", o)
                }
            },
            {
                key: "render",
    ...
    lH70: function(e, t, n) {
        ...
        var i = o.webpackDependencies || (o.webpackDependencies = {}),
        a = n("efr4"); !
        function() { (o.nunjucksPrecompiled = o.nunjucksPrecompiled || {})["app/components/ListCardAD/template.nunjucks"] = function() {
                        ...
                        if (i += '\n<i class="icon_ad">\n    <span data-show="show"\n        ad-log-extra="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "log_extra"), e.opts.autoescape), i += '"\n        data-track="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_track_url"), e.opts.autoescape), i += '"\n        ad-id="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_id"), e.opts.autoescape), i += '"\n        ad-tag="embeded_ad"\n        ad-label="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_label"), e.opts.autoescape), i += '">\n    </span>\n</i>\n\n', r.contextOrFrameLookup(t, n, "is_download_ad") || r.contextOrFrameLookup(t, n, "is_phone_ad")) {
                            if (i += '\n<div class="article_link clearfix creative_type"\n    ad-tag="{tag}}"\n    ad-url="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "source_url"), e.opts.autoescape), i += '"\n    ', r.contextOrFrameLookup(t, n, "is_download_ad") && (i += 'ad-load="true"'), i += '\n    ad-id="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_id"), e.opts.autoescape), i += '"\n    ad-log-extra="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "log_extra"), e.opts.autoescape), i += '">\n\n    ', 2 == r.contextOrFrameLookup(t, n, "image_mode") && (i += '\n    <div class="desc">\n    '), i += '\n\n    <h3 class="dotdot line3 ', 2 == r.contextOrFrameLookup(t, n, "image_mode") && (i += "image-margin-right"), i += '"\n        ', r.contextOrFrameLookup(t, n, "highlight") && (i += 'highlight="', i += r.suppressValue(e.getFilter("dump").call(t, r.memberLookup(r.contextOrFrameLookup(t, n, "highlight"), "title")), e.opts.autoescape), i += '"'), i += ">\n        ", i += r.suppressValue(r.contextOrFrameLookup(t, n, "title"), e.opts.autoescape), i += "\n    </h3>\n\n    ", 4 == r.contextOrFrameLookup(t, n, "image_mode")) {
                                ...
                                l = 0; l < s.length; l++) {
                                    ...
                                    i += r.suppressValue(r.memberLookup(c, "url"), e.opts.autoescape),
                                    i += "\" onerror='errorimg.call(this)' onload='loadimg.call(this)'>\n            </li>\n            "
                                }
                                n = n.pop(),
                                i += "\n        </ul>\n    </div>\n    "
                            }
                            ...
                            i += r.suppressValue(r.contextOrFrameLookup(t, n, "comment_count"), e.opts.autoescape),
                            i += "</span>\n\n        ",
                            ...
                            if (i += '\n<a href="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "source_url"), e.opts.autoescape), i += '"\n    class="article_link clearfix "\n    data-action-label="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "action_label"), e.opts.autoescape), i += '"\n    data-tag="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "tag"), e.opts.autoescape), i += '">\n\n    ', r.contextOrFrameLookup(t, n, "middle_mode") && (i += '\n    <div class="desc">\n    '), i += '\n\n    <h3 class="dotdot line3 ', r.contextOrFrameLookup(t, n, "middle_mode") && (i += "image-margin-right"), i += '"\n        ', r.contextOrFrameLookup(t, n, "highlight") && (i += 'highlight="', i += r.suppressValue(e.getFilter("jsonify").call(t, r.memberLookup(r.contextOrFrameLookup(t, n, "highlight"), "title")), e.opts.autoescape), i += '"'), i += ">\n        ", i += r.suppressValue(r.contextOrFrameLookup(t, n, "title"), e.opts.autoescape), i += "\n    </h3>\n\n    ", r.contextOrFrameLookup(t, n, "more_mode")) {
                                ...
                                p = 0; p < d.length; p++) {
                                    ...
                                    n.set("loop.length", f),
                                    i += '\n            <li class="list_img_holder">\n                <img src="',
                                    i += r.suppressValue(r.memberLookup(h, "url"), e.opts.autoescape),
                                    i += "\" onerror='errorimg.call(this)' onload='loadimg.call(this)'>\n            </li>\n            "
                                }
                                n = n.pop(),
                                i += "\n        </ul>\n    </div>\n    "
                            ...
                            r.contextOrFrameLookup(t, n, "ad_label") && (i += '\n        <span class="gg_label space">', i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_label"), e.opts.autoescape), i += "</span>\n        "),
                            i += "\n\n        ",
                            r.contextOrFrameLookup(t, n, "subject_label") || (i += '\n        <span class="src space', "百度经验" == r.contextOrFrameLookup(t, n, "source") && (i += "recommend_label"), i += '">', i += r.suppressValue(r.contextOrFrameLookup(t, n, "source"), e.opts.autoescape), i += "</span>"),
                            i += '\n\n        <span class="cmt space">评论 ',
                            i += r.suppressValue(r.contextOrFrameLookup(t, n, "comment_count"), e.opts.autoescape),
                            i += "</span>\n\n        ",
                            r.contextOrFrameLookup(t, n, "middle_mode") || (i += '\n        <span class="time" title="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "datetime"), e.opts.autoescape), i += '">', i += r.suppressValue(r.contextOrFrameLookup(t, n, "timeago"), e.opts.autoescape), i += "</span>\n        "),
                            i += '\n\n        <span data-id="',
                            i += r.suppressValue(r.contextOrFrameLookup(t, n, "group_id"), e.opts.autoescape),
                            i += '"\n            class="dislike-news ',
                            r.contextOrFrameLookup(t, n, "middle_mode") && (i += "mid-space"),
                            i += ' fr">\n        </span>\n    </div>\n    ',
                            r.contextOrFrameLookup(t, n, "middle_mode") && (i += '\n    </div>\n    <div class="list_img_holder">\n        <img ', r.contextOrFrameLookup(t, n, "ad_type") || (i += 'src="', i += r.suppressValue(r.contextOrFrameLookup(t, n, "image_url"), e.opts.autoescape), i += '"'), i += "\n            onerror='errorimg.call(this)'\n            onload='loadimg.call(this)'/>\n        ", r.contextOrFrameLookup(t, n, "has_video") && (i += '\n        <span class="video-btn"></span>\n        '), i += "\n    </div>\n    "),
                            i += "\n"
                        }
    ...
    lxt5: function(e, t, n) {
        ...
        default)(t, [{
            ...
            },
            {
                ...
                default.createElement("p", null, "已加载好您感兴趣的头条"), m.
                default.createElement("div", {
    ...
    oFNu: function(e, t, n) {
        "use strict"; (function(t) {
            ...
            function o(e) {
                var t = e.cache_key || "listArticleReact___all__",
                n = e.data || [];
                try {
                    localStorage[t] = (0, b.
                default)(n),
                    localStorage[t + "_lastmodified"] = +new Date
                } catch(e) {
            ...
            function i(e) {
                ...
                if (n[r]) return ! 1;
                if (!Y.
            default.localStorageEnabled) return ! 1;
                if (!localStorage.getItem(t)) return ! 1;
                var o = Number(localStorage.getItem(t + "_lastmodified" || 0)),
                i = +new Date - o;
            ...
            var ie = function(e) {
                ...
                default)(this, n);
                    var t = (0, g.
                default)(this, (n.__proto__ || (0, d.
                default)(n)).call(this, e));
                    return (0, H.
                default)(),
                    t.channelCategoryList = t.props.topMenuInfo.list,
                    t.defaultCategory = t.props.topMenuInfo.defaultCategory,
                    t.state = {
                        GTMValue: {},
                        tabList: t.getTabs(),
            ...
            default)(n, [{
                    ...
                    value: function() {
                        var e = this,
                        t = Y.
                    default.localStorageEnabled() ? localStorage.menuDefaults: "";
                        return (t ? t.split(",") : (0, l.
                    default)(this.channelCategoryList).slice(0, 12)).reduce(function(t, n) {
                            if (e.channelCategoryList[n]) return t[n] = e.channelCategoryList[n],
                            t
                        },
                        {})
                    }
                },
                {
                    ...
                    value: function() {
                        var e = Y.
                    default.hash("channel") || Y.
                    default.request("channel") || this.defaultCategory;
                        return - 1 === (0, l.
                    default)(this.channelCategoryList).indexOf(e) && (e = this.defaultCategory),
                        -1 === (0, l.
                    default)(this.getTabs()).indexOf(e) && (e = this.defaultCategory),
                        window.maevent("channel", e, ""),
                        e
                    }
                },
                {
                    ...
                    value: function(e, t) {
                        ...
                        null, location.pathname + "?" + r) : location.hash = t
                    }
                },
                {
                ...
                },
                {
                    ...
                    value: function(e, n) {
                        var r = this;
                        this.fetchLock = !0;
                        var i = this.state.listData,
                        a = n ? n.direction || "prepend": "prepend",
                        s = i[e] || [],
                        u = 0,
                        l = 0;
                        ...
                        z.
                    default.get("/list/?" + $.
                    default.stringify(c)).end(function(n, u) {
                            if (r.fetchLock = !1, n) return r.setState({
                                fetchTips: X.NETWORKTIPS.RETRY
                            }),
                            null;
                            var l = JSON.parse(u.text);
                            if (0 === l.return_count) return r.setState({
                                fetchTips: X.NETWORKTIPS.RECOMMENDEMPTY
                            }),
                            null;
                            var c = l.data;
                            r.state.doADTest.doADTest && c.splice(r.state.doADTest.position - 1, 0, {
                                doADTest: !0
                            }),
                            o({
                            ...
                            "append" === a ? (s = [].concat(s, c), window.refreshCount ? window.refreshCount = window.refreshCount + 1 : window.refreshCount = 1) : "prepend" === a && (s = [].concat(c, s)),
                            "prepend" === a && (r.setState({
                                showRefreshTip: !0
                            }), setTimeout(function() {
                                r.setState({
                                    showRefreshTip: !1
                ...
                },
                {
                    ...
                    value: function(e, t) {
                        var n = this;
                        this.shouldFetchListData(e, this.state.listData) && (this.setState({
                            rotateRefreshBtn: !0
                        }), setTimeout(function() {
                            n.setState({
                                rotateRefreshBtn: !1
                ...
                },
                {
                    ...
                    value: function(e, t) {
                        ...
                        this.shouldFetchListData(n, this.state.listData) && this.fetchListData(n, t),
                        oe.
                    default.scrollChangeDisable = !0,
                ...
                },
                {
                    key: "handleMenuClick",
                    value: function(e, t) {
                        this.state.listData[e] || this.fetchListDataIfNeed(e),
                        this.changeHash(e, t),
                        this.changeChannelScrollPosition(e),
                        this.setState({
                            currentChannel: e
                        }),
                        window.maevent("channel", e, "")
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        this.channelScrollPosition[t] = window.scrollY,
                        window.scrollTo(0, this.channelScrollPosition[e] || 0)
                    }
                },
                {
                    key: "handleMoreClick",
                    value: function() {
                        window.location = Y.
                    default.appendQuery("/channels/", "need_open_window=1"),
                ...
                },
                {
                    ...
                    value: function(e) {
                        "append" === e && ne.
                    default.checkReferrer && window.refreshCount >= 20 || this.getListData({
                            direction: e
                        })
                    }
                },
                ...
                },
                {
                    ...
                    value: function() {
                        var e = this,
                        t = this.state.GTMValue.hideTopBar,
                        n = this.state,
                        r = n.tabList,
                        o = n.currentChannel,
                        i = n.listData,
                        ...
                        u = n.showRefreshTip,
                        l = n.fetchTips,
                        c = n.rotateRefreshBtn,
                        d = n.GTMValue;
                        this.props.isLite && (t = !1);
                        var f = this.props.Header || C.
                    default,
                        p = this.props.TopMenu || M.
                    default,
                        h = this.props.MainContent || S.
                    default,
                        m = this.props.DownloadBanner || N.
                    default;
                        return k.
                    default.createElement("div", {
                            id: "indexContainer",
                    ...
                    default)({
                            ...
                            onClickShowAuditInfo: function() {
                                return e.setState({
                                    showAuditInfo: !e.state.showAuditInfo
                                })
                            },
                            showAuditInfo: this.state.showAuditInfo
                        },
                        this.props)), this.state.showAuditInfo ? k.
                    default.createElement(W.
                    default, null) : k.
                    ...
                    default, {
                        ...
                        }), !this.props.hideDownloadBanner && k.
                    default.createElement(m, null)))
                    }
                }]),
                n
            } (x.Component);
    ...
    rCoH: function(e, t, n) {
        ...
        i.
    default && a.some(function(e) {
            var t = c(e, "request");
            if (t in window) return s = c(e, "cancel"),
            u = function(e) {
                return window[t](e)
            }
        });
    ...
    sfAD: function(e, t, n) {
        ...
        e.exports = function(e, t, n, i) {
            ...
            u > 0 && l > u && (l = u);
            for (var c = 0; c < l; ++c) {
                var d, f, p, h, m = e[c].replace(s, "%20"),
                v = m.indexOf(n);
                v >= 0 ? (d = m.substr(0, v), f = m.substr(v + 1)) : (d = m, f = ""),
    ...
    wFHU: function(e, t, n) {
        ...
        y = function(e) {
            ...
            default)(this, (t.__proto__ || (0, i.
            default)(t)).call(this));
                return e.handleScroll = e.handleScroll.bind(e),
                e.handleTouchStart = e.handleTouchStart.bind(e),
                e.handleTouchEnd = e.handleTouchEnd.bind(e),
                e.state = {
                    scrollY: 0,
                    touchStartY: 0
                },
        ...
        default)(t, [{
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    n = document.body.scrollHeight; (window.scrollY || window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop) >= n - window.innerHeight - t && this.props.handleScroll("append")
                }
            },
            {
    ...
    wYmI: function(e, t, n) {
        ...
        e.exports = {
            ...
            function(e, t, r) {
                try {
                    r = n("QgN4")(Function.call, n("faNU").f(Object.prototype, "__proto__").set, 2),
                    r(e, []),
    ...
    wtgB: function(e, t, n) { (function(t, r) {
            /*!
 ...
 */
            ...
            function() {
                ...
                function g(e, t, n) {
                    G(function(e) {
                        ...
                        "Settle: " + (e._label || " unknown promise")); ! r && o && (r = !0, k(e, o))
                    },
                    e)
                }
                function y(e, t) {
                    t._state === ne ? x(e, t._result) : t._state === re ? k(e, t._result) : T(t, void 0,
                    function(t) {
                        return _(e, t)
                    },
                    function(t) {
                ...
                function w(e, t, n) {
                    t.constructor === e.constructor && n === c && t.constructor.resolve === d ? y(e, t) : n === oe ? (k(e, oe.error), oe.error = null) : void 0 === n ? x(e, t) : o(n) ? g(e, t, n) : x(e, t)
                }
                function _(t, n) {
                ...
                function j(e, t) {
                    ...
                    this.promise[ee] || S(this.promise),
                    q(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? x(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), 0 === this._remaining && x(this.promise, this._result))) : k(this.promise, N())
                }
                function N() {
                ...
                function B(e) {
                    ...
                    this._subscribers = [],
                    f !== e && ("function" != typeof e && F(), this instanceof B ? M(this, e) : I())
                }
                function U() {
                    var e = void 0;
                    if (void 0 !== r) e = r;
                ...
                function() {
                    try {
                        var e = n(0);
                        return K = e.runOnLoop || e.runOnContext,
                        s()
                    } catch(e) {
                        return u()
                    }
                ...
                j.prototype._eachEntry = function(e, t) {
                    ...
                    if (r === d) {
                        var o = m(e);
                        if (o === c && e._state !== te) this._settledAt(e._state, t, e._result);
                ...
                j.prototype._settledAt = function(e, t, n) {
                    var r = this.promise;
                    r._state === te && (this._remaining--, e === re ? k(r, n) : this._result[t] = n),
    ...
    xDfE: function(e, t, n) {
        ...
        var x = function(e) {
            ...
            default)(t)).call(this, e));
                return n.state = {
                    currentChannel: e.defaultChannel
                },
                n
            }
            return (0, m.
        ...
        default)(t, [{
                ...
                value: function(e) {
                    ...
                    n = e.currentTarget.dataset.query;
                    this.setState({
                        currentChannel: t
                    }),
                    this.props.onMenuClick && this.props.onMenuClick(t, n),
                    e.preventDefault()
                }
            },
            {
            ...
            },
            {
                ...
                value: function() {
                    var e = this,
                    t = this.props.tabList,
                    n = this.props.GTMValue || {},
                    r = n.hideTopMenuMore || this.props.hideTopMenuMore,
                    o = this.props.className || "";
                    return g.
                default.createElement("div", {
                        className: "top_menu_bar " + o
                    },
                    r ? null: g.
                default.createElement("div", {
                ...
                default.createElement("div", {
                    ...
                    (0, i.
                default)(t).map(function(n) {
                        var r = (0, b.
                    default)("btn", {
                            cur: n === e.state.currentChannel
                        });
                        return g.
                    default.createElement("a", {
                            href: "javascript:void(0)",
    ...
    default.node, {
        ...
        g = function(e) {
            ...
            t.prototype.render = function() {
                ...
                delete r.component,
                d.
            default.createElement(this.props.component, r, t)
            },
            t
        } (d.
    default.Component);
    ...
    xbLF: function(e, t, n) {
        ...
        var k = (w.
    default.node, b.nameShape.isRequired, w.
    default.bool, w.
    default.bool, w.
    default.bool, w.
    default.number, w.
    ...
    default.number,
        function(e) {
            function t() {
                ...
                u = Array(s), l = 0; l < s; l++) u[l] = arguments[l];
            ...
            default)(r, o),
                ...
                var l = function(e) {
                    e && e.target !== r || (clearTimeout(a), u && u(), (0, f.
                default)(r, o), (0, f.
                default)(r, i), u && u(), t && t())
                };
            ...
            t.prototype.queueClassAndNode = function(e, t) {
                ...
                this.rafHandle || (this.rafHandle = (0, h.
            default)(function() {
            ...
            t.prototype.render = function() {
                ...
                delete e.children,
                g.
            default.cloneElement(g.
            default.Children.only(this.props.children), e)
            },
            t
        } (g.
    default.Component));
    ...
    yRjA: function(e, t, n) {
        "use strict"; (function(t) {
            ...
            function l() {
                ...
                i() && (e = 16),
                T.
            default.browser.weixin && (e = 41);
                var t = "UA-28423340-" + e;
                navigator.userAgent.indexOf("ArticleStreamSdk") > -1 || "open" === O.
            default.request("utm_campaign") ? t = "UA-28423340-11": "m.ixigua.com" === location.host && (t = "UA-28423340-51"),
            ...
            function d() {
                var e = O.
            default.request("wxshare_count"); ! isNaN(e) && e > 0 && window.ga("set", "dimension1", e);
                var t = O.
            default.request("wxshare_banner"); ! isNaN(t) && t > 0 && window.ga("set", "dimension10", t);
                var n = O.
            default.request("readmore"); ! isNaN(n) && n > 0 && window.ga("set", "dimension2", n);
                var r = O.
            default.hash("channel") || O.
            default.request("channel") || "__all__";
                ...
                default.request("app");
                    ...
                    var s = O.
                default.request("utm_medium");
                    s && window.ga("set", "dimension7", s);
                    var u = O.
                default.request("isappinstalled"); ! isNaN(u) && u >= 0 && window.ga("set", "dimension8", u - 0 ? 1 : 0)
                } else window.ga(function(e) {
                    var t = e.get("clientId");
                    window.ga("set", "dimension7", t)
                }),
                window.ga("set", "dimension6", O.
            default.getBrowserName()),
                window.ga("set", "dimension8", navigator.userAgent),
                window.ga("set", "dimension9", window.city || "");
                var l = location.pathname;
                l && -1 !== l.indexOf("/sem/") && O.
            default.request("atdl") && window.ga("set", "dimension5", O.
            default.request("atdl"))
            }
            function f() {
                var e = 2;
                i() && (e = 5);
                var t = A.
            default.getTTWebID(),
                n = null !== t ? parseInt(t) % 100 : void 0;
                return ! isNaN(n) && n >= 1 && n <= e
            }
            function p() {
                var e = new Image;
    ...
    ye30: function(e, t, n) {
        ...
        default)(e) || (e.className = e.className + " " + t)
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        }),
    ...
    zTA1: function(e, t, n) {
        ...
        m = r(h),
        v = n("2Z17"),
        g = (v.nameShape.isRequired, d.
    default.bool, d.
    default.bool, d.
    default.bool, (0, v.transitionTimeout)("Appear"), (0, v.transitionTimeout)("Enter"), (0, v.transitionTimeout)("Leave"), {
            transitionAppear: !1,
            transitionEnter: !0,
            transitionLeave: !0
        }),
