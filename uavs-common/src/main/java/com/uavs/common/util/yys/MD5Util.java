...
public class MD5Util {
    ...
    public static void main(String[] args) {
		String timestamp = "201707191550";
		String appUserName = "mianbaoyun";
		String appKey = "AXUSXEAUQRPGTKBNPVBI";
		
		String tokenSign = MD5Util.md5Hex(appUserName+timestamp+appKey);
		System.out.println("tokenSign："+tokenSign);
		
		/**----------------------*/
		String token = "ZYZGAWBHVETFHDZWVSZGXREPIQQWPA";
		
		String mdStr=appUserName+timestamp+token+appKey;
		
		String sign = MD5Util.md5Hex(mdStr);
