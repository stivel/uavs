...
public class VerifyCodeUtils {
     ...
     * @throws IOException
     */
    public static void outputImageSM(int width, int height, OutputStream os, String code) throws IOException{
        int verifySize = code.length();
        BufferedImage image = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
        Font mFont = new Font("Times New Roman", Font.PLAIN, 12);
...
//            g.drawChars(chars, i, 1, ((w-10) / verifySize) * i + 5, h/2 + fontSize/2 - 10);
//        }
